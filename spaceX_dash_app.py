...
if __name__ == '__main__':
    app.run_server()
'''
Which site has the largest successful launches? CCAFS LC-40 has the largest successful launches with 19 successful launches
Which site has the highest launch success rate? KSC LC-39A has a 76.9% success rate (out of 10 launches)
